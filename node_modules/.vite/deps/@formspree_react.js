    ...
    var b2 = class {
      ...
      submitForm(i, s) {
        return R(this, arguments, function* (t, r, o = {}) {
          ...
          this.session && (l["Formspree-Session-Data"] = j2(this.session.data())), r instanceof FormData || (l["Content-Type"] = "application/json");
          ...
          if (this.stripePromise && o.createPaymentMethod) {
            ...
            return f && f.stripe && f.stripe.requiresAction && f.resubmitKey ? yield B2({ stripePromise: this.stripePromise, responseData: f, response: y, payload: d, data: r, fetchImpl: n2, request: u, url: p }) : _({ response: y, body: f });
          } else
            return n2(p, u).then((d) => d.json().then((y) => _({ body: y, response: d }))).catch();
        });
      }
    };
    var x2 = (e) => new b2(e);
...
var q = (r, o = {}) => {
  let [i, p] = (0, import_react2.useState)(null), [c, a] = (0, import_react2.useState)(false), [u, l] = (0, import_react2.useState)(false), [w, f] = (0, import_react2.useState)([]), d = S(), T = o.client || d, P, h;
  if (!T)
  ...
  return [{ result: i, submitting: c, succeeded: u, errors: w }, async (g) => {
    let R = async (t) => {
      t.preventDefault();
      let s = t.target;
      if (s.tagName != "FORM")
    ...
    return a(true), d.client.submitForm(r, e, { endpoint: o.endpoint, clientName: `@formspree/react@${j}`, createPaymentMethod: d.client && d.client.stripePromise ? M : void 0 }).then((t) => {
